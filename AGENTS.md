...
- **Measurement Studio layout**: Desktop shell follows QC Studio fixed-height behavior; page/header/canvas stay fixed while History and Measurement Items scroll independently. Narrow screens fall back to page scroll for stacked panels.
