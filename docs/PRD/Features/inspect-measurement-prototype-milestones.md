...
| 2026-08-10 | Measurement canvas alignment + controls | Frontend `161 passed`, build passed, Playwright `8 passed`; image/SVG bounding-box assertion | Wider QC Studio-style panels; shared image frame fixes overlay alignment; zoom/pan and high-contrast candidate overlays implemented. |
