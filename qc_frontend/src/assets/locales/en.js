export default {
  ...
  measurement: {
    ...
    taskOverall: 'Overall dimension (X/Y)',
    overallX: 'Overall X',
    overallY: 'Overall Y',
    ...
    overlayControls: 'Measurement overlay controls',
    showDetectedEdges: 'Detected',
    showEvaluatedMeasurements: 'Results',
    showCalibrationReference: 'Calibration',
    selectEdgeHint: 'Click an edge to measure',
    selectOverallHint: 'Select Overall X or Overall Y',
