...
[Live Monitor] Start Camera raw preview
    ...
    OR [Quantity Detection] Image upload / video frame / camera snapshot -> annotated canvas + filmstrip + crop evidence -> delete redundant crops if needed -> verify total verdict -> save check with persisted crop URLs
...
| `/quantity/history` | **Quantity History** | Saved QuantityCheck records with search/filter, selected CSV/PDF export modal, combined crop Inspect dialog, and Delete confirmation |
