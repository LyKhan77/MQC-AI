...
- **Measurement Studio layout**: QC Studio-style fixed-height desktop shell keeps header and canvas stationary; History and Measurement Items use separate internal scroll regions. On narrow screens, the shell falls back to page scroll so stacked panels remain reachable.
